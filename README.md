# genpark-autonomous-software-engineering-lifecycle-agent-skill
...
> **GenPark AI Agent Skill** -- Autonomous software engineering lifecycle agent & automated PR builder (Devin style)
